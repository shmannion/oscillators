...
if __name__ == "__main__":
    ...
    values = [(0.0 + 0.02*i) for i in range(0,20)]
    ...
    S.pulse_amp = 1.0 
    S.pulse_width = 64.0
    S.frequency_distribution = ("fixed", [12.783,12.783 - values[ind]])
    ...
    outfile_raw = f'{outdir}/exp_9_raw_{ind}.csv'
    outfile_summ = f'{outdir}/exp_9_summ_{ind}.csv'
