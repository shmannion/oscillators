...
if __name__ == "__main__":
    ...
    values = [0.5, 1.0, 1.5, -0.5, -1.0, -1.5]
    ...
    S.phase_distribution = ("fixed", [0.0, 0.0 + values[ind]]) 
    S.dt = 0.01
    S.tmax = 30.0
    S.initialise_system()
    ...
    outfile_raw = f'{outdir}/exp_6_raw_{ind}.csv'
    outfile_summ = f'{outdir}/exp_6_summ_{ind}.csv'
