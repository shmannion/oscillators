...
if __name__ == "__main__":
    ...
    width_vals = [32.0, 64.0]
    amp_vals = [1.0, 1.5]
    f_vals = [0.0, 0.01, 0.02, 0.03, 0.04]
    p_vals = [0.1, 0.2, 0, -0.1, -0.2]
    values = {}
    i = 0
    for j in width_vals:
        for k in amp_vals:
    ...
    outfile_raw = f'{outdir}/exp_11_raw_{ind}.csv'
    outfile_summ = f'{outdir}/exp_11_summ_{ind}.csv'
    ...
    for c1 in c_values:
        for c2 in c_values:
            ...
            for x,y,z in zip(corrs_m1, corrs_0, corrs_1):
                ...
                'c3': c3,
                'c4': c4,
                'pulse_amp': 1.0 + values[ind][1],
                'pulse_width': 64.0 + values[ind][0],
                'sigma_freq': 0.0,
                'sigma_phase': 0.0,
                'lagm1': x,
                'lag0': y,
