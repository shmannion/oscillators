...
if __name__ == "__main__":
    ...
    outfile_raw = f'{outdir}/exp_7_raw_{ind}.csv'
    outfile_summ = f'{outdir}/exp_7_summ_{ind}.csv'
    ...
    for c1 in c_values:
        for c2 in c_values:
            c3 = c1
            c4 = c2
            S.phase_noise = 0.0 + vals[ind][0] 
            S.frequency_noise = 0.0 + vals[ind][1]  
            ...
            for x,y,z in zip(corrs_m1, corrs_0, corrs_1):
                ...
                'pulse_amp': 1.0,
                'pulse_width': 64.0,
                'sigma_freq': 0.0 + values[ind][0],
                'sigma_phase': 0.0 + values[ind][1],
                'lagm1': x,
                'lag0': y,
                'lag1': z
                })
