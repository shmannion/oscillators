...
if __name__ == "__main__":
    ...
    S.pulse_amp = 1.0
    S.pulse_width = 64.0 
    S.frequency_distribution = ("fixed", [12.783,12.783 - deltaf_values[deltaf_ind]])
    ...
    outfile_raw = f'{outdir}/exp_3_raw_{deltaf_ind}.csv'
    outfile_summ = f'{outdir}/exp_3_summ_{deltaf_ind}.csv'
    ...
    for c1 in c_values:
        for c2 in c_values:
            ...
            for x,y,z in zip(corrs_m1, corrs_0, corrs_1):
                rows.append({
                'f1': 12.783,
                'f2': 12.783 - deltaf_values[deltaf_ind],
                'p1': 0,
                'p2': 0,
                'c1': c1,
                'c2': c2,
